module Feedzirra
  ...
  class Feed
    ...
    def self.add_common_feed_entry_element(element_tag, options = {})
      # Create a list of all Classes inside of the Feedzirra::Parser namespace
      # As long as a user writes their own class inside of the Feedzirra::Parser
      # namespace it will be included here
      list_of_classes = Feedzirra::Parser.constants.map(&Feedzirra::Parser.method(:const_get)).grep(Class)
      list_of_classes.each do |klass|
