  ...
  describe "#update_from_feed" do
    describe "updating feed attributes" do
      before(:each) do
        ...
        # Removed call to #dup because nested objects were not being dup'ed.
        # They had the same object_ids, and thus when you changed an attribute
        # on @feed, it was mirrored in @updated_feed
