...
describe Feedjira::Parser::AtomYoutubeEntry do
  describe "parsing" do
    ...
    it "has the published date" do
      expect(@entry.published).to eq Feedjira::Utils.parse_time_safely("2015-05-04T00:01:27+00:00")
    end

    it "has the updated date" do
      expect(@entry.updated).to eq Feedjira::Utils.parse_time_safely("2015-05-13T17:38:30+00:00")
    end
